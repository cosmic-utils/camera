...
2. The token must have write access to the [flathub/io.github.cosmic-utils.camera](https://github.com/flathub/io.github.cosmic-utils.camera) repository
...
1. Check the [Flathub Buildbot](https://buildbot.flathub.org/#/apps/io.github.cosmic-utils.camera)
...
# 2. Commit the change
git add resources/io.github.cosmic-utils.camera.metainfo.xml
