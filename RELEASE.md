...
2. The token must have write access to the [flathub/io.github.freddyfunk.cosmic-camera](https://github.com/flathub/io.github.freddyfunk.cosmic-camera) repository
...
1. Check the [Flathub Buildbot](https://buildbot.flathub.org/#/apps/io.github.freddyfunk.cosmic-camera)
...
# 2. Commit the change
git add resources/io.github.freddyfunk.cosmic-camera.metainfo.xml
