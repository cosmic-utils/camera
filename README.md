...
[![Flathub](https://img.shields.io/flathub/v/io.github.cosmic-utils.camera?logo=flathub&logoColor=white)](https://flathub.org/apps/io.github.cosmic-utils.camera)
...
<a href='https://flathub.org/apps/io.github.cosmic-utils.camera'><img width='240' alt='Get it on Flathub' src='https://flathub.org/api/badge?svg&locale=en'/></a>

```bash
# Install from Flathub
flatpak install flathub io.github.cosmic-utils.camera
